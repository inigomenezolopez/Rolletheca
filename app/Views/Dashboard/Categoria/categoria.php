        ...
        <tbody>
            <?php foreach ($categorias as $categoria): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm" role="button" href="/categoria/ver/<?= esc($categoria->id) ?>">Ver</a>
                        <?php if (session('usuario')->rol == 'admin'): ?>
                            <a href="/categoria/editar/<?= esc($categoria->id) ?>" class="btn btn-primary btn-sm" role="button">Editar</a>
                            <form action="/categoria/eliminar/<?= esc($categoria->id) ?>" method="post" style="display: inline-block;">
