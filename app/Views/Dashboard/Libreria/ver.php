        ...
        <div class="col-12">
            ...
            <div class="mt-auto">
                ...
                <div class="botones-accion">
                    <a href="/libreria/editar/<?= esc($libro->id) ?>" id="botonEditar" class="button"
        ...
        <div class="col-12">
            <form action="/comentarios/agregar" method="post" data-libro-id="<?= $libro->id ?>">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="contenido" name="contenido" class="form-control" value="<?= old('contenido') ?>"
                        required></textarea>
                </div>
                    ...
                    <div class="card mb-3" id="comentario-<?= $comentario->id ?>">
                        <div class="row g-0">
                            <div class="col-md-4 text-center">
                                <img src="<?= esc($comentario->imagen ? base_url('/images/usuario/' . $comentario->imagen) : base_url('/images/usuario/img_predeterminada.png')) ?>"
                                    alt="avatar" class="img-fluid rounded-circle my-3"
                                    style="width: 140px; height: 140px;">
                                <h5><?= esc($comentario->usuario) ?></h5>
                                <div>
                                    <?php for ($i = 1; $i <= 5; $i++): ?>
                                    <i
                                        class="<?= $i <= $comentario->valoracion ? 'fas fa-star star-filled' : 'far fa-star star-empty'; ?>"></i>
                                    <?php endfor; ?>
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <div class="card-text" id="vista-comentario-<?= $comentario->id ?>">
                                        ...
                                        <div class="botones-accion">
                                            <a href="<?= site_url('/libreria/editar/comentario/' . $comentario->id) ?>"
                                                id="botonEditar" class="button" style="text-decoration: none;">
                                                <button class="edit-button">
                                                    <svg class="edit-svgIcon" viewBox="0 0 512 512">
                                                        <path
                                                            d="M410.3 231l11.3-11.3-33.9-33.9-62.1-62.1L291.7 89.8l-11.3 11.3-22.6 22.6L58.6 322.9c-10.4 10.4-18 23.3-22.2 37.4L1 480.7c-2.5 8.4-.2 17.5 6.1 23.7s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L387.7 253.7 410.3 231zM160 399.4l-9.1 22.7c-4 3.1-8.5 5.4-13.3 6.9L59.4 452l23-78.1c1.4-4.9 3.8-9.4 6.9-13.3l22.7-9.1v32c0 8.8 7.2 16 16 16h32zM362.7 18.7L348.3 33.2 325.7 55.8 314.3 67.1l33.9 33.9 62.1 62.1 33.9 33.9 11.3-11.3 22.6-22.6 14.5-14.5c25-25 25-65.5 0-90.5L453.3 18.7c-25-25-65.5-25-90.5 0zm-47.4 168l-144 144c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6l144-144c6.2-6.2 16.4-6.2 22.6 0s6.2 16.4 0 22.6z">
