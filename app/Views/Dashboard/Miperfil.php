    ...
    <div class="row mt-4">
        <div class="col-md-4">
            <div class="card" style="background-color: #cbdbe5;">
                <img src="<?= esc($usuario->imagen ? base_url('/images/usuario/' . $usuario->imagen) : base_url('/images/usuario/img_predeterminada.png')) ?>"
                    class="card-img-top rounded-circle" alt="<?= esc($usuario->usuario) ?>"
                    style="width: 130px; height: 130px; object-fit: cover; border-radius: 50%; margin: 0 auto;">
        ...
        <div class="col-md-8">
            <form action="/usuario/actualizar-perfil" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <img id="imagenRecorte"
                        src="<?= esc($usuario->imagen ? base_url('/images/usuario/' . $usuario->imagen) : base_url('/images/usuario/img_predeterminada.png')) ?>"
                        alt="Vista previa" style="display: none; max-width: 100%; max-height: 100%;">
                    <br>
                ...
                reader.onload = function() {
                    ...
                    cropper = new Cropper(imagenRecorte, {
                        ...
                        crop: function(event) {
                            ...
                            document.getElementById('height').value = event.detail
                                .height;
                        }
                    });
