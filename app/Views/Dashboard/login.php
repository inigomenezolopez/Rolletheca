    ...
    <div class="container-fluid principal">
        <div class="row main-content bg-success text-center">
            <div class="col-md-4 text-center company__info">
                <span class="company__logo"><img src="/images/logo.jpeg" class="logo-image" alt=""></span>
            ...
            <div class="col-md-8 col-xs-12 col-sm-12 login_form ">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <form action="<?= route_to('usuario.login_post')?>" method="post" control="" class="form-group">
                            <div class="row">
                                <input type="text" name="correo" id="correo" class="form__input"
                ...
                <div class="row">
                    <p>¿Olvidaste tu contraseña? <a href="<?= base_url('recuperar-contrasena') ?>">Restablecer
                            contraseña</a></p>
                </div>
            </div>
        </div>
